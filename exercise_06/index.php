<?php
    ...
    | Each article should have a link to the article.php with the ID passed
    | in the url (eg: article.php?id=0 to display the first article).
    |
    | Only display the first 100 characters of the description.
    |
    | If you want to go further, pass the title of the article instead of an ID.
    | Be sure that what you're passing is URL safe.
    |
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4">  
                ...
                <a class="btn btn-primary" href="article.php?id=42">Afficher</a>
                <hr>
            </div>
            <!-- END Articles list -->
        </div>
